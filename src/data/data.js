export const EjerciciosJSON = [
    ...
    ejercicios: [
      {
        ...
        numero: 1,
        enunciado:
          "Crea un programa que dibuje un triángulo cuyos ángulos midan 120 grados y elige el tamaño que quieras para sus lados.",
        urlAyuda: "/img/help/ej1.png",
        urlSol: "/img/sol/ej1.png"
      },
      {
        id: "2",
        numero: 2,
  ...
  {
    categoria: "Condiciones y Variables",
    ejercicios: [
      {
        id: "4",
        numero: 4,
  ...
  {
    categoria: "Comunicación entre objetos",
    ejercicios: [
      {
        id: "20",
        numero: 20,
